<template>
	<view>
		<button @click="toMain" type="primary" style="margin-top: 30px; margin-left: 40px;width:300px;">返回</button>
		<page-head :title="title"></page-head>

		<uni-list-item style="margin-top: 80px;">
			<view slot="header" class="slot-box">
				<text style="font-size: 20px;margin-right: 10px;">抽水水泵的状态</text>
			</view>
		...
		<uni-list-item>
			<view slot="header" class="slot-box">
				<text style="font-size: 20px;margin-right: 10px;">送水水泵的状态</text>
			</view>
